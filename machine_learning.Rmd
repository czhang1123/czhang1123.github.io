...
In this study, we want to predict a person's manner of performing barbell lifts, given data from accelerometers on the belt, forearm, arm, and dumbell. Various machine learning models were explored and built, with out of sample error reported out. The best performing model, which is a random forest model, achieves almost 100% accuracy on a new data sample.
